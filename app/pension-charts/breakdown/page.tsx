                        ...
                        {g.items.map((item, i) => {
                          ...
                          return (
                            <div key={item.name} className="flex items-center gap-2">
                              ...
                              <span className="text-xs font-semibold text-gray-600 w-12 text-right">{pct.toFixed(1)}%</span>
                              {item.수익률 !== null && (
                                <span className={`text-[10px] font-semibold w-14 text-right ${item.수익률 > 0 ? 'text-red-400' : item.수익률 < 0 ? 'text-blue-400' : 'text-gray-400'}`}>
