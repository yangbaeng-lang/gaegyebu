            ...
            <div className="bg-[#1a1f2e] rounded-2xl overflow-hidden">
              <div className="px-5 py-[22px] space-y-3">
                ...
                <div className="grid grid-cols-3 gap-2">
                  <div>
                    <p className="text-[10px] text-gray-500 mb-0.5">자산</p>
                    <p className="text-[13px] font-semibold text-white tabular-nums">{fmt(totalAssets)}</p>
                  </div>
                  <div>
                    <p className="text-[10px] text-gray-500 mb-0.5">부채</p>
                    <p className="text-[13px] font-semibold text-[#ff7070] tabular-nums">{fmt(totalLiab)}</p>
                  </div>
                  <div>
                    <p className="text-[10px] text-gray-500 mb-0.5">순자산</p>
